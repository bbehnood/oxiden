use oxiden_buffer::{Buffer, Position, Range, RopeStorage};

#[test]
fn insert_and_delete() {
    let mut buffer = Buffer::new(RopeStorage::new());
...
fn large_document_survives_many_edits() {
    ...
    // A handful of edits scattered through the middle of a document large
    // enough to span many rope leaves.
